...
time.sleep(1)
irrelevent_q1 = input("Are you familar with the state of the nation? Y or N")
if irrelevent_q1 in ["y", "Y"]:
	...
	time.sleep(2)
	print ("please do excuse me if I am wrong, no one really takes a silly old Court Jester to serious.")
	time.sleep(3)
	print ("Your brother was a tad bit egotistical, and he left our fine kingdom in extreme disaray.")
	time.sleep(3)
	...
	time.sleep(3)
	print ("If you didn't want to pay those taxes, you had to join the millitary. Which was certain death, Blackspire was ruthless!")
	time.sleep(6)
else:
	print (Y or N)
print("Now you should be well aqquianted with the state of our nations, I feel that you will be able to get our kingdom to be the most prosperous of all time!")